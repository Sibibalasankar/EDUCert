...
const Login = () => {
  ...
  const handleSubmit = (e) => {
    ...
    alert('Traditional login is not implemented yet. Please use wallet connection.');
  };
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-2 text-center text-sm text-gray-600">
          Access your certificates and verification portal
        </p>
      </div>
        ...
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          ...
          <div className="flex border-b border-gray-200 mb-6">
            <button
              ...
              className={`flex-1 py-2 px-3 text-center font-medium text-sm ${
                loginType === 'student'
          ...
          <div className="mb-6">
            ...
            <p className="mt-2 text-center text-sm text-gray-600">
              Recommended for students and admins
            </p>
          </div>
              ...
              <div className="ml-3">
                ...
                <div className="mt-2 text-sm text-blue-700">
                  <ul className="list-disc list-inside space-y-1">
                    <li><strong>Students:</strong> Connect wallet or use email login</li>
                    <li><strong>Admins:</strong> Connect admin wallet for certificate issuance</li>
                    <li><strong>Verifiers:</strong> No login required for verification</li>
                  </ul>
                </div>
              </div>
            </div>
